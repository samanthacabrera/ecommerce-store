const EtsyStore = () => {
    return (
        <div className="max-w-2xl mx-auto p-12 space-y-6">
            <h2 className="text-3xl text-center">Find Yarn<span className="italic">sana</span> on Etsy</h2>
            <p> Yarnsana started on Etsy, and it’s still a great place to explore past creations, read customer reviews, and shop new drops. </p>
