...
const EtsyStore = () => {
    return (
        <div className="flex flex-col justify-center h-full w-full px-4">
            ...
            <div className="space-y-4 p-6 bg-white/10 rounded-xl">
            ...
            <a 
                ...
                className="flex items-center space-x-2 bg-white/20 px-4 py-2 w-fit rounded-xl mx-auto text-white hover:bg-white/30 transition duration-300 ease-in-out"
            > 
